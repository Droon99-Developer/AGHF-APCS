...
public class DirectionPanel extends JPanel {
	...
	private void unitTable() {
		...
		Object[][] data = { { "Speed (#Number of slices moved per turn)", 5, 1, 2, 4, 1 },
	...
	private void shortcuts() {
		...
		Object[][] data = { { "Upgrade Base", "-" }, { "End Turn", "[Enter]" }, { "Show Units Panel", "=" },
				{ "Buy Air Strike", "1" }, { "Buy Tank", "2" }, { "Buy Marine", "3" }, { "Buy Infantry", "4" },
				{ "Buy Medic", "5" }, { "Scroll", "A and D or Left and Right Arrow Keys" }, };
